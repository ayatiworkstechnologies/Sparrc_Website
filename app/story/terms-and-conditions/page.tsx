...
const termsSections: TermsSectionData[] = [
  ...
  {
    title: "Section 4- Modification to the Service and Prices",
    paragraphs: [
  ...
  {
    title: "Section 9- Third Party Link",
    paragraphs: [
...
},
{
  ...
  paragraphs: [
    `Questions about the Terms of Service should be sent to us at admin@sparrc.com`,
  ],
},
];
  ...
  return (
    <main className="overflow-hidden bg-white">
      ...
      <section className="relative overflow-hidden px-5 py-14 sm:px-7 sm:py-16 md:px-10 lg:px-14 lg:py-20 xl:px-20">
        ...
        <div className="pointer-events-none absolute -left-40 bottom-[12%] h-96 w-96 rounded-full bg-[#286cba]/[0.035] blur-[130px]" />
