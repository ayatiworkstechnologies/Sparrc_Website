...
const therapiesMenu = [
  {
    ...
    href: "/how-we-help/alternate-therapy/cranio-sacral-therapy",
  },
  {
    title: "Musculoskeletal Assessment",
    href: "/how-we-help/alternate-therapy/musculoskeletal-assessment",
  },
];
  ...
  return (
    <>
      ...
      <DynamicDepartmentDetail
        ...
        activeHref="/how-we-help/alternate-therapy/musculoskeletal-assessment"
        showCTA={false}
        sections={[
          {
            layout: "content",
