        ...
        sections={[
          {
            eyebrow: "",
            icon: "personStanding",
            heading: "Healthy Ageing & Longevity",
            content:
              "Healthy Ageing & Longevity deals with diagnosing and treating the elderly population with cardiopulmonary, musculoskeletal and mobility issues through exercise interventions. SPARRC Geriatric Fitness has been able to inspire thousands of elderly people. Among them, we have veteran athletes who perform at the national and international level at the age groups of 80 and 90. For the general geriatric population though, having the ability to go about their everyday life without pain, to be able to sleep well and wake up refreshed are victories that can be guaranteed by the prescription exercise program at SPARRC.",
            layout: "content",
          },
          {
            eyebrow: "",
            icon: "heartPulse",
            heading: "What is Healthy Ageing & Longevity?",
            content:
              "Healthy Ageing & Longevity is to ensure the loss of muscle mass, loss of bone mass, loss of confidence and loss of joint mobility can be minimized in older people such that they are able to be independently take care of themselves and live a life that is fulfilling.",
            images: [
          ...
          },
          {
            eyebrow: "",
            icon: "activity",
            heading: "How does Healthy Ageing & Longevity exercises work?",
            content:
