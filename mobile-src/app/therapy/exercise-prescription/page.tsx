...
const prescriptionExerciseDetails: TherapyInfoItem[] = [
  {
    id: 1,
    icon: "/mobile/icons/duration.svg",
  ...
  {
    id: 2,
    icon: "/mobile/icons/session-type.svg",
  ...
  {
    id: 4,
    icon: "/mobile/icons/consultation.svg",
...
export default function PrescriptionExercisePage() {
  return (
    <main className="w-full overflow-hidden pt-[70px]">
      <TherapyBanner
        src="/mobile/images/prescription-exercise-banner.png"
