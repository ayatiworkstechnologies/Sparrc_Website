...
const navItems: NavItem[] = [
  ...
  { name: "About", href: "/about" },
  {
    ...
    columns: 3,
    dropdown: [
      { label: "Assessment & Exercise Lab", slug: "assessment-exercise-lab" },
      ...
      { label: "Mind, Behaviour & Recovery", slug: "mind-behaviour-recovery" },
      { label: "Non-Surgical Care", slug: "non-surgical-care" },
      ...
      { label: "Workplace Health", slug: "workplace-health" },
      { label: "Rehabilitation", slug: "rehabilitation" },
      { label: "Weight & Metabolic Health", slug: "weight-metabolic-health" },
      { label: "Fames For Differently Abled", slug: "fames-for-differently-abled" },
      { label: "Training Programs", slug: "training-programs" },
      { label: "Healthy Ageing & Longevity", slug: "healthy-ageing-longevity" },
